...
function Weathercurrentlocation() {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          setCoords([lat.toString(),lon.toString()]);
  ...
  return (
    <div className="min-h-screen text-white font-sans font-bold bg-no-repeat bg-cover bg-center bg-currentlocation">
      {/* Header */}
      <header className="rounded-t-lg p-4">
        <div className="mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center mr-4 ">
            ...
            <h1 className="p-2">{t("currentPosition")}</h1>
          </div>
        </div>
      </header>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 grid-rows-14 gap-10">
            <div className="row-span-2 col-span-3 backdrop-blur-md rounded-lg p-4 shadow-md">
              <a
                ...
                href={`https://weather.com/de-DE/wetter/heute/l/${coords}`}
                target="_blank">
                {t("temperature")}
              </a>
